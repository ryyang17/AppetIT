...
export function ProductDetailModal({ 
  ...
  return (
    <div className="absolute top-8 left-0 right-0 bottom-13 z-50 flex items-center justify-center p-3 bg-black bg-opacity-50">
      <Card className="w-full max-w-sm max-h-full bg-white rounded-xl overflow-hidden shadow-2xl flex flex-col border-0">
